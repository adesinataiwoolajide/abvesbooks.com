                            ...
                            <?php 
                                if($totalItems > 0){ ?>
                                    <ul>
                                        <?php $b = $page - 1;
                                        if($page != 1){ ?>
                                            <li class="prev"><a href="manufacturer_product.php?manufacturer_name=<?php echo $publisher_name ?>&&page=<?php echo $page - 1?>" 
                                                class="buy-btn">Previous <i class="fa fa-angle-left"></i></a>
                                            </li>
                                        <?php } ?>

                                        <?php if($page != $totalPages){ ?>
                                            <li><a href="manufacturer_product.php?manufacturer_name=<?php echo $publisher_name ?>&&page=<?php echo $page + 1?>" 
