                                        ...
                                        <?php
                                            ...
                                            foreach($_SESSION['cart'] as $item){
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="action"><a href="handlers/cart/removeFromCart.php?slug=<?php echo $item['slug'];?>"><i class="icon-close"></i></a></td>
                                                </tr>
                                                <?php 
                        ...
                        <div class="sidebar-checkout block">
                            ...
                            <div class="block-content">
                                <dl>
                                    ...
                                    <a href="shipping-cart.php">Change</a> 
                                    </dt>
                                    <dd class="complete">
                                        <address>
                                        ...
                                        <dt class="complete"> Shipping Address <span class="separator">|</span> <a href="shipping-address.php.php">Change</a> </dt>
                                        <dd class="complete">
                                            <address>
