                ...
                <div class="col-main col-sm-9 col-xs-12">
                    <div class="product-view-area">
                        <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
                            ...
                            <div class="large-image"> <a href="<?php echo "assets/images/product/".$details['image'] ?>" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> 
                                <img class="zoom-img" src="<?php echo "assets/images/product/".$details['image'] ?>" alt="products" style="height:300px; width:350px"> </a> 
                            </div>
                    ...
                    <!--                <div class="product-tabs-content-inner clearfix">-->
                                        <!--<p><strong>More Details</strong><span>&nbsp;is-->
                            ...
                            <?php 
								...
								foreach($product->getAllProductByPublis($publisher_id) as $listPub){ ?>
                                    <li class="item">
                                        ...
                                        title="Sample Product" class="product-image"><img src="<?php echo "assets/images/product/".$listPub['image'] ?>" alt=""></a></div>
                        ...
                        <div class="slider-items-products">
                            <div id="related-product-slider" class="product-flexslider hidden-buttons">
                                <div class="slider-items slider-width-col4 fadeInUp">
                                    <?php 
                                    $genre_id = $details['genre_id'];
                                    foreach($product->listSingleGensProductListing($genre_id) as $related){ ?>
                                                ...
                                                <div class="product-thumbnail">
                                                    ...
                                                    <div class="pr-img-area"> 
                                                        <a title="Product title here" href="product_details.php?slug=<?php echo $related['slug']; ?>">
                                                            <figure> 
                                                                <img class="first-img" src="<?php echo 'assets/images/product/'.$related['image']; ?>" alt="<?php echo $related['product_name'] ?>" style="height:250px; width:250px"> 
                                                                <img class="hover-img" src="<?php echo 'assets/images/product/'.$related['image']; ?>" alt="<?php echo $related['product_name'] ?>" style="height:250px; width:250px">
                                                            </figure>
                                                        </a> 
                                                    </div>
                                                ...
                                                <div class="item-info">
                                                    <div class="info-inner">
                                                        ...
                                                        <div class="item-content">
                                                            <div class="rating">  <i class="fa fa-star-o"></i> 
