<?php 
    ...
    if(isset($_POST['search_product'])){
        $search = strtoupper($all_purpose->sanitizeInput($_POST['name']));
            ...
            <div class="container">
                <div class="row"><?php
                    if(empty($search)){ ?>
                                    ...
                                    <?php 
                                        if($totalItems > 0){ ?>
                                            <ul>
                                                <?php $b = $page - 1;
                                                if($page != 1){ ?>
                                                    <li class="prev"><a href="search_product.php?page=<?php echo $page - 1?>" 
                        ...
                        $totalItem =  count($product->searchProduuct($search));
                        
                        $itemsPerPage = 12;
                        $end = isset($_GET['page']) ? ($_GET['page']) : 1;
                        $begin = $end > 1 ? ($end * $itemsPeraPage) - $itemsPerPage : 0;
                        $totalPages = ceil($totalItems / $itemsPerPage);
                        ?>
                        <div class="col-main col-sm-9 col-xs-12 col-sm-push-3"><?php
                            if($totalItem == 0){ ?>
                                ...
                                <div class="shop-inner">
                                    ...
                                    <div class="product-grid-area">
                                        <ul class="products-grid"><?php
                                            foreach($product->searchProduuct($search) as $listShop){ ?>
                                                <li class="item col-lg-4 col-md-4 col-sm-6 col-xs-6 ">
                                                    <div class="product-item">
                                                        <div class="item-inner">
                                                            <div class="product-thumbnail">
