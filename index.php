    ...
    <div class="home-tab">
        <div class="tab-title text-left">
            ...
            <ul class="nav home-nav-tabs home-product-tabs">
                <li class="active"><a href="#newarrival" data-toggle="tab" aria-expanded="false">New Arrival</a></li>
                <li><a href="#demand" data-toggle="tab" aria-expanded="false">Popular Demand</a></li>
                <li><a href="#feature" data-toggle="tab" aria-expanded="false">Feature Products</a></li>
                <li><a href="#bestseller" data-toggle="tab" aria-expanded="false">Best Seller</a></li>
            </ul>
        </div>
        <div id="productTabContent" class="tab-content">
            <div class="tab-pane active in" id="newarrival">
                                                ...
                                                <div class="pr-img-area"> 
                                                    <a title="Product title here" href="product_details.php?slug=<?php echo $listOne['slug']; ?>">
                                                        <figure> 
                                                            ...
                                                            <img class="hover-img" src="<?php echo 'assets/images/product/'.$listOne['image']; ?>" alt="<?php echo $listOne['product_name'] ?>">
                                                        </figure>
                                                    </a> 
                                                </div>
                                                ...
                                                <div class="pr-img-area"> 
                                                    <a title="Product title here" href="product_details.php?slug=<?php echo $listGen['slug']; ?>">
                                                        <figure> 
                                                            ...
                                                            <img class="hover-img" src="<?php echo 'assets/images/product/'.$listGen['image']; ?>" alt="<?php echo $listGen['product_name'] ?>">
                                                        </figure>
                                                    </a> 
                                                </div>
                                                <div class="pr-info-area">
												...
												<div class="pr-img-area"> 
													<a title="<?php echo $manu['product_name'] ?>" href="product_details.php?slug=<?php echo $manu['slug']; ?>">
														<figure> 
															...
															<img class="hover-img" src="<?php echo 'assets/images/product/'.$manu['image']; ?>" alt="<?php echo $manu['product_name'] ?>">
														</figure>
													</a> 
												</div>
												<div class="pr-info-area">
          		...
          		<div class="top-sellers-pro">
            		<div class="slider-items-products">
              			<div id="photo-slider" class="product-flexslider hidden-buttons">
							<div class="slider-items slider-width-col4 ">
								<?php 
								foreach($product->getAllProductByQuantity() as $amt){ ?>
									<div class="product-item">
										<div class="item-inner">
											<div class="product-thumbnail">
												<div class="icon-new-label new-left">New</div>
												<div class="pr-img-area"> 
													<a title="<?php echo $amt['product_name'] ?>" href="product_details.php?slug=<?php echo $amt['slug']; ?>">
														<figure> 
															...
															<img class="hover-img" src="<?php echo 'assets/images/product/'.$amt['image']; ?>" alt="<?php echo $amt['product_name'] ?>">
														</figure>
													</a> 
												</div>
												<div class="pr-info-area">
					...
					<div class="col-md-3 top-banner hidden-sm">
						<div class="jtv-banner3">
							<div class="jtv-banner3-inner">
								<a href="#"><img src="assets/images/image_1463408667-93493b6449.jpg" alt="HTML template"></a>
								<div class="hover_content">
									<div class="hover_data">
										<div class="title"> Big Sale </div>
										<div class="desc-text">Up to 55% off</div>
										<span>Books and Stationaries
										 </span>
										<p><a href="shop.php" class="shop-now">Get it now!</a></p>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="jtv-best-sale-list">
							...
							<div class="slider-items-products">
								<div id="jtv-best-sale-slider" class="product-flexslider">
									<div class="slider-items"><?php
										foreach($product->getAllProductByWeight() as $listWeight){ ?>
											<div class="product-item">
												<div class="item-inner">
													<div class="product-thumbnail">
														<div class="icon-new-label new-left">New</div>
														<div class="pr-img-area"> <a title="Product title here" href="product_details.php?slug=<?php echo $listWeight['slug']; ?>">
															<figure> <img class="first-img" src="<?php echo 'assets/images/product/'.$listWeight['image']; ?>" alt="<?php echo $listWeight['product_name'] ?>"> 
															<img class="hover-img" src="images/product-2.jpg" alt="<?php echo $listWeight['product_name'] ?>"></figure>
															</a> 
														</div>
														<div class="pr-info-area">
															<div class="pr-button">
																<div class="mt-button add_to_wishlist"> <a href="handlers/registration/addit.php?slug=<?php echo $listWeight['slug'] ?>&&action=<?php echo 'Wishlist' ?>"> <i class="fa fa-heart-o"></i> </a> </div>
																<div class="mt-button add_to_compare"> <a href="handlers/registration/addit.php?slug=<?php echo $listWeight['slug'] ?>&&action=<?php echo 'Compare' ?>"> <i class="fa fa-link"></i> </a> </div>
																<div class="mt-button quick-view"> <a href="product_details.php?slug=<?php echo $listWeight['slug']; ?>"> <i class="fa fa-shopping-cart"></i> </a> </div>
															</div>
														</div>
													</div>
													<div class="item-info">
														<div class="info-inner">
															<div class="item-title"> 
																<a title="<?php echo $listWeight['product_name'] ?>" href="product_details.php?slug=<?php echo $listWeight['slug']; ?>">
																	<?php echo $listWeight['product_name'] ?> 
																</a> 
															</div>
															<div class="item-content">
																...
																<div class="item-price">
																	<div class="price-box"> <span class="regular-price"> <span class="price">&#8358;<?php echo number_format($amt['amount']); ?></span> </span> </div>
																</div>
																<!-- <div class="pro-action">
																	<button type="button" class="add-to-cart"><span> Add to Cart</span> </button>
																</div> -->
							...
							<div class="col-md-5 hot-pr-img-area">
								<div id="daily-deal-slider" class="product-flexslider hidden-buttons">
									<div class="slider-items slider-width-col4 "><?php 
										foreach($product->getAllProduct() as $show){ ?>
											<div class="pr-img-area"> <a title="<?php echo $show['product_name'] ?>" href="product_details.php?slug=<?php echo $show['slug'] ?>">
												<figure> <img class="first-img" src="<?php echo 'assets/images/product/'.$show['image']; ?>" alt="<?php echo $show['product_name'] ?>"></figure>
												</a> 
											</div><?php 
										} ?>
