<?php
    ...
    $lots = $location->getSingleLocation($location_id);
?>
...
<div class="content-wrapper">
    <div class="container-fluid">
        <div class="row pt-2 pb-2">
            <div class="col-sm-9">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="edit-shipping-location.php?location=<?php echo $loca ?>&&location_id=<?php echo $locationid ?>" 
                    ">Edit Shipping Location</a></li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header"><i class="fa fa-table"></i> Please Fill The Below Form ToEdit The Shipping Location</div>
                    <div class="card-body">
                        <form action="update-location.php" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    placeholder="Enter The Shipping Location " value="<?php echo $loca ?>">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    placeholder="Enter The Charges" value="<?php echo $lots['charge'] ?>">
                                    <span style="color: red">** This Field is Required **</span>     
                                </div>
                                <input type="hidden" name="prev_name" value="<?php echo $loca ?>">
