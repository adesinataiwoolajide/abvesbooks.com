                ...
                <div class="card profile-card-2">
                    ...
                    <div class="card-body border-top border-light">
                        ...
                        <div class="media align-items-center">
                            ...
                            <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                                    <p>Total Asset <span class="float-right">&#8358;<?php echo number_format($add*$details['amount']); ?></span></p>
                                    <div class="progress" style="height: 5px;">
                        ...
                        <div class="media align-items-center">
                            <div><img src="<?php echo "../../assets/images/product/".$details['image'] ?>" class="skill-img" alt="skill img"></div>
                                <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                                    <p>Quantity <span class="float-right"><?php echo  $details['quantity']; ?></span></p>
                                    <div class="progress" style="height: 5px;">
                        ...
                        <div class="media align-items-center">
                            <div><img src="<?php echo "../../assets/images/product/".$details['image'] ?>" class="skill-img" alt="skill img"></div>
                                <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                                    <p>Price <span class="float-right">&#8358;<?php echo  number_format($details['amount']); ?></span></p>
                                    <div class="progress" style="height: 5px;">
                                        <div class="progress-bar gradient-ibiza" style="width:100%"></div>
                                    </div>
                                </div>                   
                        ...
                        <div class="media align-items-center">
                            <div><img src="<?php echo "../../assets/images/product/".$details['image'] ?>" class="skill-img" alt="skill img"></div>
                                <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                                    <p>Weight <span class="float-right"><?php echo  ($deel['weight_name']); ?></span></p>
                                    <div class="progress" style="height: 5px;">
                                        <div class="progress-bar gradient-purpink" style="width:100%"></div>
                                    </div>
                                </div>                   
                        ...
                        <div class="media align-items-center">
                            <div><img src="<?php echo "../../assets/images/product/".$details['image'] ?>" class="skill-img" alt="skill img"></div>
                                <div class="media-body text-left ml-3">
                                <div class="progress-wrapper">
                                    <p>Weight Amount<span class="float-right">&#8358;<?php echo  number_format($deel['amount']); ?></span></p>
                                    <div class="progress" style="height: 5px;">
                                        <div class="progress-bar gradient-scooter" style="width:100%"></div>
                                    </div>
                                </div>                   
                                    ...
                                    <h5 class="mt-2 mb-3"><span class="fa fa-clock-o ion-clock float-right"></span> Product Details</h5>
                                        ...
                                        <table class="table table-hover table-responsive">
                                            ...
                                            <tbody>                                    
                                                <tr>
                                                    <td>Edition</td >  
                                                    <td><?php echo $details['edition'] ?></td>
                                                </tr>
                                            </tbody>
                                            <tbody>                                    
                                                <tr>
